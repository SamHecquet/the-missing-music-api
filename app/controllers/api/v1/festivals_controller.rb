  ...
  class FestivalsController < ApiController
    ...
    private
      ...
      def set_festival
        ...
        unless @festival.instance_of?(Festival) and @festival.valid? and !@festival.shouldBeUpdated
        ...
        list_festival_name.each do |festival_name|
          ...
          if resp.code.match(/20\d/)
            ...
            artist_list.each do |name|
              ...
              unless artists.find {|artist| artist.name == name.text or artist.slug == artist_name}
                if new_artist.valid?
                  # artists << new_artist
            ...
            if festival.instance_of?(Festival) and festival.valid? and festival.save
              @festival = festival
            else
              @festival = nil
            end
